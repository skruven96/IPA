...
void Runtime::initialize()
{
	...
	{
		if ((*it)->is_static())
			*(OpCodes*)(m_heap + (*it)->address()) = (*it)->opcode();
	}

	start_call(m_project->initialization_function()).call(nullptr, m_project->void_t());
}


Runtime& Runtime::start_call(Function* function)
{
	m_call = function;
	m_argument = function->arguments_begin();
...
{
	assert(m_argument != m_call->arguments_end() && "To many arguments given. ");
	assert((*m_argument)->type() == m_project->u8_t() && "Argument is off wrong type. ");

	(u8&)m_stack[(*m_argument++)->address()] = value;
...
{
	assert(m_argument != m_call->arguments_end() && "To many arguments given. ");
	assert((*m_argument)->type() == m_project->i8_t() && "Argument is off wrong type. ");

	(i8&)m_stack[(*m_argument++)->address()] = value;
...
{
	assert(m_argument != m_call->arguments_end() && "To many arguments given. ");
	assert((*m_argument)->type() == m_project->u16_t() && "Argument is off wrong type. ");

	(u16&)m_stack[(*m_argument++)->address()] = value;
...
{
	assert(m_argument != m_call->arguments_end() && "To many arguments given. ");
	assert((*m_argument)->type() == m_project->i16_t() && "Argument is off wrong type. ");

	(i16&)m_stack[(*m_argument++)->address()] = value;
...
{
	assert(m_argument != m_call->arguments_end() && "To many arguments given. ");
	assert((*m_argument)->type() == m_project->u32_t() && "Argument is off wrong type. ");

	(u32&)m_stack[(*m_argument++)->address()] = value;
...
{
	assert(m_argument != m_call->arguments_end() && "To many arguments given. ");
	assert((*m_argument)->type() == m_project->i32_t() && "Argument is off wrong type. ");

	(i32&)m_stack[(*m_argument++)->address()] = value;
...
{
	assert(m_argument != m_call->arguments_end() && "To many arguments given. ");
	assert((*m_argument)->type() == m_project->u64_t() && "Argument is off wrong type. ");

	(u64&)m_stack[(*m_argument++)->address()] = value;
...
{
	assert(m_argument != m_call->arguments_end() && "To many arguments given. ");
	assert((*m_argument)->type() == m_project->i64_t() && "Argument is off wrong type. ");

	(i64&)m_stack[(*m_argument++)->address()] = value;
...
{
	assert(m_argument != m_call->arguments_end() && "To many arguments given. ");
	assert((*m_argument)->type() == m_project->f32_t() && "Argument is off wrong type. ");

	(f32&)m_stack[(*m_argument++)->address()] = value;
...
{
	assert(m_argument != m_call->arguments_end() && "To many arguments given. ");
	assert((*m_argument)->type() == m_project->f64_t() && "Argument is off wrong type. ");

	(f64&)m_stack[(*m_argument++)->address()] = value;

	return *this;
}


void Runtime::call(void* return_value, Type* return_type)
{
	assert(m_argument == m_call->arguments_end() && "To few arguments given. ");
	assert(return_type == m_call->return_type() && "Return type dosen't match. ");

	OpCodes code = m_call->opcode();
